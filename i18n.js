...
window.EDM_I18N = {
  en: {
    ...
    'form.tzHint': 'Your star mansion uses the traditional Chinese <strong>二十八宿值日</strong> almanac — the mansion on duty for your <strong>birth-place local date</strong>, cycling one mansion per day. The Chinese day turns at <strong>子時 (23:00)</strong>, so a precise birth time and birth-place time zone pin the day exactly; leave them blank and the mansion is marked low-confidence. Your device time zone is never used.',
  ...
  zh: {
    ...
    'form.tzHint': '你的星宿采用传统的<strong>二十八宿值日</strong>历法——即你<strong>出生地当天</strong>所值之宿，每日轮换一宿。华历以<strong>子时（23:00）</strong>换日，因此精确的出生时间与出生地时区可将日期定准；留空则星宿标记为低置信度。设备时区永不使用。',
...
window.EDM_READING = {
  ...
  mansionRel: {
    same: { en: 'the same day-on-duty mansion', zh: '同一值日星宿' },
